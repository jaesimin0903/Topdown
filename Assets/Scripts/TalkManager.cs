...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData(){
        ...
        talkData.Add(2000, new string[] { "최재영은 정말 바보라고:3", "ㄹㅇㅋㅋ:3" });//npc A :number -> index
        talkData.Add(100, new string[] { "나는 책상이야" });//desk
        talkData.Add(200, new string[] { "나는 박스라구!" });//box
        //quest talk
        talkData.Add(10 + 1000, new string[] { "재영이 정말 화가나.:0", "집에오면 안치워.:0" });
        talkData.Add(11 + 2000, new string[] { "재영이를 처리할 계획을 짜고있어:3", "혼쭐을 내줄건데 너도 참여할래?:3" });
